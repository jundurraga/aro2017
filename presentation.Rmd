...
- to assess weather the acoustic complex change (eACC) can be used to measure pitch discrimination.
...
anovaLoudnessPLot <- (anovaLoudnessPLot + xlab("Pulse Shape") +
...
|                                             |                                |
|---------------------------------------------|--------------------------------|
|![](./my_figures/pulse-shapes-schematic.svg)|![](./my_figures/anova_altps.png)|
...
<!-- <section> -->
<!-- <div style="position:relative; width:800px; height:680px; margin:0 auto;"> -->
<!--   <img class="fragment" width="700" height="480" src="./my_figures/anova_altps.svg" style="position:absolute;top:0;left:0;" /> -->
<!--   <img class="fragment" width="700" height="480" src="/my_figures/anova_altps_highlighted.svg" style="position:absolute;top:0;left:0;" /> -->
<!-- </div> -->
<!-- </section> -->
...
|                                              |                              |
:---------------------------------------------:|:-----------------------------:
|![](./my_figures/pulse-shapes-schematic.svg)  |  ![](./my_figures/anova_altps_sym.png)|
